...
function CheckoutForm(props) {
    ...
    const schema = yup.object().shape({
        ...
        phone: yup.string().required("Please enter your phone number").matches(phoneRegExp, 'Phone number is not valid')
            .min(10, 'Phone number must be at least 10 digits')
    });
    const form = useForm({
        defaultValues: {
            fullName: (user.userName || clientInfo.fullName) || '',
    ...
    return (
        <form onSubmit={form.handleSubmit(handleSubmit)}>
            ...
            <InputField name="phone" label="Phone Number" form={form} fullWidth />
